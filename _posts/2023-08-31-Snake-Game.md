...
<div class="container">
    ...
    <div class="container bg-secondary" style="text-align:center;">
        ...
        <div id="setting" class="py-4 text-light">
            ...
            <br>
            <p>Speed:
                <input id="speed1" type="radio" name="speed" value="120000" checked/>
                <label for="speed1">Snail</label>
                ...
                <label for="speed5">UFast</label>
                <input id="speed6" type="radio" name="speed" value="1"/>
                <label for="speed6">HYPERSPEED</label>
                <input id="speed7" type="radio" name="speed" value="0.1"/>
                <label for="speed7">Funny</label>
            </p>
            <p>Wall:
